...
async function main() {
  ...
  const schemaBigInt = "193884990921501630296853144860102342508";

  // merklized path to field in the W3C credential according to JSONLD  schema e.g. birthday in the KYCAgeCredential under the url "https://raw.githubusercontent.com/iden3/claim-schema-vocab/main/schemas/json-ld/kyc-v3.json-ld"
  const schemaClaimPathKey =
    "16146105467742506189812633246817712943092768956243515149211871937402971482852";
  ...
  const query = {
    ...
    value: [42, ...new Array(63).fill(0).map((i) => 0)], // for operators 1-3 only first value matters
  };

  // add the address of the contract just deployed
  const ERC20VerifierAddress = "0xC45c78BFF2a35B458b3106D20CC21876384F7310"
